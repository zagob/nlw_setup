...
const WEEK_DAYS = 7;
const SCREEN_HORIZONTAIL_PADDING = (32 * 2) / 5;

export const DAY_MARGIN_BETWEEN = 8;
export const DAY_SIZE =
  Dimensions.get("screen").width / WEEK_DAYS - (SCREEN_HORIZONTAIL_PADDING + 5);
  ...
  return (
    <TouchableOpacity
      ...
      className={clsx("rounded-lg border-2 m-1", {
        ...
        ["bg-violet-400 border-violet-200"]: amountAccomplishedPercentage >= 90,
